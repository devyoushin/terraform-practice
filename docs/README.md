...
| `checklists/` | apply 전 점검과 모듈 리뷰 기준 |
| `runbooks/` | drift detection, state import 운영 절차 |
| `rules/` | 문서 작성 규칙, Terraform 컨벤션, 보안/모니터링 체크리스트 |
| `templates/` | 서비스 문서, 런북, 장애 보고서 템플릿 |
| `outputs.md` | plan, graph, 점검 결과 보관 규칙 |
...
| `../ops/README.md` | Terraform/Terragrunt 운영 실행 가이드 |
...
- 모듈 바로 옆에서 필요한 `ops/legacy/*/README.md`는 해당 모듈의 로컬 사용 설명서로 유지합니다.
