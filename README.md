...
| 모듈 | 설명 |
|------|------|
| [vpc](./legacy/vpc/) | VPC, 서브넷, NAT Gateway, VPC Endpoints, Flow Logs |
| [ec2](./legacy/ec2/) | EC2 인스턴스, EBS, Security Groups, IAM 프로파일 |
| [alb](./legacy/alb/) | Application Load Balancer, HTTPS/ACM, 액세스 로그 |
| [rds](./legacy/rds/) | RDS MySQL 8.0, Multi-AZ, 백업, Performance Insights |
| [eks](./legacy/eks/) | EKS 클러스터, 관리형 노드 그룹, Karpenter, IRSA |
| [ecr](./legacy/ecr/) | ECR, 이미지 스캔, 수명 주기 정책 |
| [elasticache](./legacy/elasticache/) | ElastiCache Redis, Multi-AZ, 암호화, 스냅샷 |
| [dynamodb](./legacy/dynamodb/) | DynamoDB, OnDemand/Provisioned, GSI, PITR |
| [s3](./legacy/s3/) | S3 버킷, 버전 관리, 수명 주기, 암호화 |
| [cloudfront](./legacy/cloudfront/) | CloudFront CDN, OAC, WAF 연동, 커스텀 도메인 |
| [waf](./legacy/waf/) | WAF v2, IP 차단, 레이트 리밋, 관리형 규칙 |
| [iam](./legacy/iam/) | IAM 역할: EC2, GitHub OIDC (CI/CD), EKS IRSA |
| [kms](./legacy/kms/) | KMS 키, 자동 교체, 멀티 리전 |
| [secrets-manager](./legacy/secrets-manager/) | Secrets Manager, KMS 암호화, 자동 교체 |
| [cloudwatch](./legacy/cloudwatch/) | CloudWatch Logs, 알람, 대시보드, SNS |
| [bastion](./legacy/bastion/) | Bastion 호스트, SSM Session Manager, SSH |
| [route53](./legacy/route53/) | 호스팅 존, DNS 레코드, 헬스 체크, 페일오버 |
| [sqs-sns](./legacy/sqs-sns/) | SQS 큐, SNS 토픽, DLQ, 구독 |
| [backup](./legacy/backup/) | AWS Backup, 볼트, 계획, 보존 기간 관리 |
| [guardduty](./legacy/guardduty/) | GuardDuty, 위협 감지, SNS 알림, 심각도 필터 |
| [codepipeline](./legacy/codepipeline/) | CodePipeline, CodeBuild, ECS 배포 (Rolling/Blue-Green) |
| [tgw](./legacy/tgw/) | Transit Gateway, 허브-앤-스포크, VPN, RAM 공유 |
...
레거시 패턴은 각 모듈의 `legacy/{모듈}/` 디렉토리에서 직접 실행합니다.

```bash
cd legacy/vpc/envs/dev
