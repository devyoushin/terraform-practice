...
### PROD 환경 IAM Role 모음
### - 필요한 모듈만 주석 해제하여 사용
### - 프로덕션 환경: apply 전 반드시 plan 검토 필수
###############################################################################
...
#
#   role_name            = "${var.project_name}-prod-cicd"
#   github_org           = var.github_org
#   github_repo          = var.github_repo
#   create_oidc_provider = false                    # dev에서 이미 생성한 경우 false
#   existing_oidc_provider_arn = var.oidc_provider_arn_github
#   policy_arns = [
...
#
#   role_name            = "${var.project_name}-prod-app-role"
